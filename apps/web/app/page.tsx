        ...
        <div className="grid sm:grid-cols-2">
          <div className="relative p-10 sm:p-20 flex flex-col justify-center min-h-[50vh] sm:min-h-[70vh] bg-secondary/50">
            <div className="relative">
              ...
              <p className="text-muted-foreground text-[15px] leading-[1.8] max-w-sm">
                Different-sized feet. Amputees who only need one shoe.
                Millions forced to buy full pairs. One shoe goes straight to waste.
          ...
          <div className="relative p-10 sm:p-20 flex flex-col justify-center min-h-[50vh] sm:min-h-[70vh] border-l border-border bg-background">
            <div className="relative">
              ...
              <p className="text-muted-foreground text-[15px] leading-[1.8] max-w-sm">
                Whether you have mismatched feet or only need one shoe,
                myotherpair connects you with someone who needs the other.
                Same brand, same size, opposite foot. No waste. Half the cost.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-3 gap-0">
            {[
              ...
              { num: 'II',  title: 'Match',    desc: 'Our algorithm finds the complementary shoe. Whether you need the opposite foot or someone needs your spare.' },
              { num: 'III', title: 'Complete', desc: 'Connect with your match. Agree on terms. Both walk away with exactly what you need.' },
            ].map((step, i) => (
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-0">
            {[
              ...
              { icon: <MessageCircle className="h-4 w-4" />,  title: 'Private messaging',    desc: 'Negotiate price, condition, and shipping. All in-app.' },
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-0">
            {[
              ...
              { title: 'Amputees & single-foot buyers', desc: 'Only need one shoe? List your spare or buy just the one you need. No full pair required.' },
              { title: 'Conscious consumers',           desc: 'Split the cost with a stranger who needs the other shoe. Zero waste.' },
            ].map((s, i) => (
